   ...
   if (isset($_SESSION['ssNumeroOrden']))
   {
	   ...
	   //Obtener Registros
		...
		{	
			...
			if($rptDiario == "generadores_paquete")
			   $path = "../$rptDiario/";
			else
			   $path = "";
		  	echo "<td class='CrearReporte' align=center bgcolor='$ReportColor'>
						<a href=\"".$path."rptReporteDiario.php?sContrato=".$_SESSION['ssContrato']."&sNumeroOrden=".$_SESSION['ssNumeroOrden']."&dFecha=$rowOrden[0]&sIdTurno=$rowOrden[1]&sIdConvenio=$rowOrden[8]&lStatus=".$rowOrden['lStatus']."\"	 target=_blank >
