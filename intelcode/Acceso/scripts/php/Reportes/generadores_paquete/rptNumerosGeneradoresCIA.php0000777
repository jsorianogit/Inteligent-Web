...
class PDF extends FPDF
{
   ...
   function fnImprimePartidas()
   {
	  ...
	  $CuerpoPartida = 230 ;
      $anchoCaracter = 0 ;
  	  $sqlPartidasGenerador = "Select e.iConsecutivo, e.mComentarios, e.sFaseObra, a.sNumeroActividad, a.sMedida, a.dCantidadAnexo, a.mDescripcion, e1.sIsometrico, e1.sPrefijo, e1.sIsometricoReferencia, e1.dCantidad, e1.iOrdenCambio from estimaciones e INNER JOIN estimacionxpartida e1 ON (e.sContrato = e1.sContrato And e.sNumeroOrden = e1.sNumeroOrden And e.sNumeroGenerador = e1.sNumeroGenerador) INNER JOIN estimacionperiodo e2 on (e.sContrato =  e2.sContrato And e.iNumeroEstimacion = e2.iNumeroEstimacion) INNER JOIN actividadesxanexo a ON (e1.sContrato = a.sContrato and e1.sNumeroActividad = a.sNumeroActividad and a.sIdConvenio = '$sIdConvenio') where e.sContrato = '$sContrato' And e.sNumeroOrden = '$sNumeroOrden' And e.sNumeroGenerador = '$sNumeroGenerador' Order By  e1.sIsometrico, e1.sPrefijo, a.iItemOrden, e1.sIsometricoReferencia" ;      
