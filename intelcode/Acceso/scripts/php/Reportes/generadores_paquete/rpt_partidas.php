...
/*###########################################################################################
   ...
   function fnImprimePartidas($sContrato,$dIdFecha,$sNumeroOrden,$sIdTurno,$sIdConvenio,$lStatus="")
   {
      ...
      global $link,$pdf;
      //$lStatus = 'Autorizado' ;
     //echo $sContrato." <br>fecha: ".$dIdFecha." <br>orden: ".$sNumeroOrden." <br>turno: ".$sIdTurno." <br>convenio: ".$sIdConvenio." <br>status: ".$lStatus."<br><br>";
	  if(!isset($xContrato))$xContrato=0.1;
	  $pdf->Cell($xContrato);
...
bitacoradealcances b INNER JOIN alcancesxactividad a ON (b.sContrato = a.sContrato And b.sNumeroActividad = a.sNumeroActividad And b.iFase = a.iFase) Where b.sContrato = '$sContrato' And b.dIdFecha = '$dIdFecha' And b.sIdTurno = '$sIdTurno' And b.sNumeroOrden = '$sNumeroOrden' And b.sPaquete = '$rowPartidas[0]' And b.sNumeroActividad = '$rowPartidas[1]' Order By b.iFase" ;
