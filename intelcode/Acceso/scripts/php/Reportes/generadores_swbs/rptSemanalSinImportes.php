...
class semanalSinImportesPDF extends PDF
{
   var $configExiste;
   function header(){}
   ...
   function fnImprimeTitulo()
   {
     ...
     $PosYContrato=$pdf->getY();
      ...
      $pdf->MultiCell(70, 3 ,"RESUMEN SEMANAL DE NÚMEROS GENERADORES SIN IMPORTES",1,'L',1);
     ...
     $pdf->MultiCell( $tmpLimiteHoja - 90 ,3/*12*/,$arTitulos[1][2],0,'J',0);
...
'Actividad') 
where 
e.sContrato = '$sContrato' And e.sNumeroOrden = '$sNumeroOrden' And e.sNumeroGenerador = '$sNumeroGenerador' Group By e1.sNumeroActividad Order By a.iItemOrden" ;      
...
$name = "reports/Semanal_Sin_Importes_$sContrato";
