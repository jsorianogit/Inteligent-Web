...
var $header = {toString: function(){
	...
	s += site.menu(	"<a href='readme.htm'>Readme</a>",
					"<a href='http://www.activewidgets.com/grid/'>Products</a>|" +
					"<a href='http://www.activewidgets.com/messages/'>Support Forum</a>|" +
					"<a href='http://www.activewidgets.com/aw.ui/'>Documentation</a>|" +
					"<a href='http://www.activewidgets.com/download/'>Free Trial</a>|" +
					"<a href='http://www.activewidgets.com/licenses/'>Purchase</a>|" +
...
var $footer = {toString: function(){
	var s = "";
	s += site.foot();
	s += site.copyright("Copyright &copy; 2003-2007 ActiveWidgets Ltd. All Rights Reserved.");
	return s;
}};
