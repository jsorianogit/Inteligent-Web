...
//update y delete
$tablasrelaciones = array ("anexo_suministro","foliodevolucion","historico_empleados","inventario_fentrada","inventario_fsalida","inventario_historico","movimientosdealmacen");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sIdTipo");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM movimientosdealmacen";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);

//verifica las ralaciones
//$tablas = $form->relaciones("proveedores");
