...
//update y delete
$tablasrelaciones = array ("anexo_pedidos","anexo_suministro","estimacionxpartidaprov","estimacionxproveedor","inventario_fentrada","inventario_fsalida");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sIdProveedor");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM proveedores";
