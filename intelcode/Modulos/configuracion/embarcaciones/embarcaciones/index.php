...
//update y delete
$tablasrelaciones = array ("configuracion","costodeembarcacion","estimaembarcaciones","jornadasdiarias","jornadasespeciales","movimientosdeembarcacion","movimientosdepersonal","suministros");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sContrato","sIdEmbarcacion");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM embarcaciones WHERE sContrato='$sContrato'";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);

//verifica las ralaciones
//$tablas = $form->relaciones("embarcaciones");
