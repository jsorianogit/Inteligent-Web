...
//update y delete
$tablasrelaciones = array ("bitacoradeequipos","distribuciondeequipos","equipos","equiposxpersonal","estimacionxequipo","estimaequipos","paquetesdeequipo","recursosequipo");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sIdEquipo");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM equipos WHERE sContrato='$sContrato' ";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);

//verifica las ralaciones
//$tablas = $form->relaciones("equipo");
