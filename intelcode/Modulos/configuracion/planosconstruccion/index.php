...
//update y delete
$tablasrelaciones = array ("bitacoradeactividades","estimacionxisometrico","estimacionxpartida","isometricos_partidas","juntasxconcentrado","presupuestosxpartida");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sContrato","sIsometrico");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM isometricos WHERE sContrato='$sContrato'";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);

//verifica las ralaciones
//$tablas = $form->relaciones("isometricos");
