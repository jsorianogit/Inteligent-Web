...
//update y delete
$tablasrelaciones = array ("actividadesxorden","bitacoradepersonal","estimaembarcaciones","estimaequipos","estimagastos","estimapersonal","jornadasdiarias","movimientosdepersonal","ordenesdetrabajo","paquetes_p");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sIdPlataforma");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM plataformas";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);

//verifica las ralaciones
//$tablas = $form->relaciones("plataformas");
