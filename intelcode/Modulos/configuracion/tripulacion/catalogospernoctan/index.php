...
//update y delete
$tablasrelaciones = array ("actividadesxorden","bitacoradeequipos","bitacoradepersonal","configuracion","estimacionxequipo","estimacionxpersonal","jornadasdiarias","movimientosdepersonal","ordenesdetrabajo","paquetes_e","paquetes_p");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sIdPernocta");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM pernoctan";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);

//verifica las ralaciones
//$tablas = $form->relaciones("pernoctan");
