...
$ocultos =array("sContrato","sAnexo","sIdTipoConvenio","lAvanceFisico","dMontoDLL","mComentarios");
...
//update y delete
//$tablasrelaciones = array ("erogacionesmensuales","actividadescanceladas","actividadesxanexo","actividadesxorden","anexosmensuales","avancesglobales","avancesglobalesxorden","avancesxactividad","configuracion","convenios_adjuntos","distribuciondeactividades","distribuciondeanexo","distribuciondeequipos","distribuciondepersonal","reportediario");
$tablasrelaciones = array ("actividadescanceladas","actividadesxanexo","actividadesxorden","anexosmensuales","avancesglobales","avancesglobalesxorden","avancesxactividad","bitacoradepaquetes","configuracion","convenios_adjuntos","distribuciondeactividades","distribuciondeanexo","distribuciondeequipos","distribuciondepersonal","erogacionesmensuales","reportediario");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sContrato","sIdConvenio");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM convenios WHERE sContrato='$sContrato' ";

//formulario objeto
$form = new convenio($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);
