...
?>
<center>
<h2>Distribucion de Conceptos / Partidas de Ordenes de Trabajo ( A partir de una  Distribucion Mensual)</h2>
<form name='sNumeroOrden'  action='menu2.php' method='POST'>
	<br><br>
	<p>	
	Numero de Orden:
	<?php
...
<form action='conceptos2.php' method='POST'>
