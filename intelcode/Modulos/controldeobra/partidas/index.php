...
$ocultos =array("sContrato","sIdConvenio","iNivel","sSimbolo","sTipoActividad","sActividadAnterior","iItemOrden","dCargado","dInstalado","dExcedente","sIdFase","iColor","lCalculo","sEspecificacion","sWbsAnterior","dCostoMN","dCostoDLL","dDuracion","sWbs","mDescripcion");
$hidden = array("sContrato","sIdConvenio","iNivel","sSimbolo","sActividadAnterior","iItemOrden","dCargado","dInstalado","dExcedente",
"sSimbolo","sWbs","sWbsAnterior","sPaquete");
//campos con los valores que deben contener en el formulario
//de insertar
$valdefaults = array("sContrato"=>$sContrato,"sIdConvenio"=>$sIdConvenioAct);
...
$camposrelaciones = array ("sContrato","sNumeroActividad","sIdConvenio","sWbs","sTipoActividad");
...
//$tablas = $form->relaciones("actividadesxanexo");
