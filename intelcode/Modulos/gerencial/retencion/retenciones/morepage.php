...
if($tipoDocumento=='excel'){
   ...
   // Generamos el Excel
   $data[]= array("RETENCIONES Y PENAS CONVENCIONALES");
...
//comenzar a crear el reporte en pdf
$pdf->AddPage();
$pdf->AliasNbPages();
...
$Ancho = 700;//round(($pdf->w - $pdf->rMargin)-50);
$Alto = 400;//round(($pdf->h - $pdf->bMargin)-160);
