...
$ocultos =array("mCliente","mDescripcion","sUbicacion","mComentarios",
	"sCentroGestor","sCentroBeneficio","sPosicionFinanciera","sElementoPEP","sCentroCosto","sFondo","sCuentaMayor","sTipoObra","sPoliza","lStatus","sIdResidencia");
...
$sqlGeneral="SELECT * FROM personal where sContrato='$sContrato'";
