...
function initCalendar() {
    if (!year && !month && !day) {
        ...
        if (window.opener.dateField.value) {
            ...
            if (window.opener.dateType == 'datetimedmy' || window.opener.dateType == 'datetime' || window.opener.dateType == 'date' || window.opener.dateType == 'datedmy') {
    ...
    if ((window.opener.dateType != 'date' && window.opener.dateType != 'datedmy') && !clock_set) {
    ...
    function returnDate(d) {
        ...
        if (window.opener.dateType != 'date' && window.opener.dateType !== 'datedmy' ) {
