 ...
 //muestra los registros de la tabla
    function visualizar($pag="",$orderby="",$nombrecampo="")
    {
        ...
        while ($row = mysql_fetch_array($result))
        {
            ...
            echo "\n<tr>";
            echo "\n<td class='CrearReporte' >\n<a title='(5) Volumenes de Obra y Notas' href='volumenes.php?sContrato=$sContrato&dIdFecha=".$row['dIdFecha']."&sNumeroOrden=".$row['sNumeroOrden']."'>\n<img src='".$this->PathImages."volumenes.png' width=17>\n</a></td> ";
            echo "\n<td class='CrearReporte' >\n<a title='Modificar' href='?sContrato=$sContrato&dIdFecha=".$row['dIdFecha']."&sNumeroOrden=".$row['sNumeroOrden']."&sIdTurno=".$row['sIdTurno']."'>\n<img src='".$this->PathImages."editar.png' width=17>\n</a></td> ";
            echo "\n<td class='CrearReporte' >\n<a title='Eliminar' href='$_SERVER[PHP_SELF]?operacion=b&$filtro'>\n<img src='".$this->PathImages."eliminar.png' width=17>\n</a></td> ";
