...
//update y delete
$tablasrelaciones = array ("actividadesxanexo","configuracion","costodeembarcacion","estimaembarcaciones","fases","fasesxsoldadura","juntasxfase","movimientosdeembarcacion");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sIdFase");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM fasesxproyecto ";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);

//verifica las ralaciones
//$tablas = $form->relaciones("fasesxproyecto");
