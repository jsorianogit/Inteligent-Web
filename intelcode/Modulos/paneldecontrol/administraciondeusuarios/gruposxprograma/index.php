...
//update y delete
$tablasrelaciones = array ("grupos","gruposisometrico","gruposxprograma","isometricos","usuarios");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sIdGrupo");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT *  FROM gruposxprograma";
