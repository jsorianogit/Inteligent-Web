...
$ocultos =array("mDescripcion","mCliente","sIdResidencia","mComentarios","sCentroGestor","sCentroBeneficio","sPosicionFinanciera","sElementoPEP","sCentroCosto","sFondo","sCuentaMayor","sTipoObra","sPoliza","lStatus");
...
$sqlGeneral="SELECT *  FROM contratos";
