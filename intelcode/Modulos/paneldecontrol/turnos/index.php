...
//update y delete
$tablasrelaciones = array ("avancesglobalesxorden","bitacoradeactividades","bitacoradealcances","bitacoragerencial","jornadasdiarias","movimientosdepersonal","reportediario","tiempomuerto","tramitedepermisos");

//Array de campos llaves que relacinan a las tablas
$camposrelaciones = array ("sContrato","sIdTurno");

//consulta sql de donde tomar los campos para el formulario
//solo puede tener clausula where
$sqlGeneral="SELECT * FROM turnos WHERE sContrato='$sContrato' ";

//formulario objeto
$form = new formulario($sqlGeneral,$ocultos,$bloqueados,$valdefaults,$camposrelaciones,$tablasrelaciones);
$hidden =array("sContrato");
$form->fcampoHidden($hidden);
//verifica las ralaciones
//$tablas = $form->relaciones("turnos");
