   ...
   ie4 = (document.all)? true:false
	...
	function domTableEnhance()
	{
		...
		for (k=0;k<alltables.length;k++)
		{
			...
			{
			//	tds=bodies[i].getElementsByTagName('td')
			//	for (j=1;j<tds.length;j++)
				//{
					//Leer el Wbs
					//getCellByRowCol(j,4);
					//Leer el Numero de Actividad
					//getCellByRowCol(j,5);
					//Contraro
					//NumeroOrden
				//}
...
if($row = mysql_fetch_array($result)){
		echo "<br><font color='RED'>F3 Para Ver Acumulado de la Partida</font><br>";
		$form->visualizar($pag,$_SESSION['OrdenarPor'],$nombres);
}	
else
	echo "<br><br><br><center><table borer=2 bgcolor='#00AA00'><tr><td><font color='BLUE'><h3>Sin Registros</h3></font></td></tr></table></center>";


?>
<!-- ##################################################################################################################################-->
<table width="679" height="352">
