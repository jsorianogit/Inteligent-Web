   ...
   if(!$iUltimaFase or   $controlador !=0){
      ...
      for($i =   $cont ; $i <=$iFase;$i++){
      	...
      	//Guardar en bitacora de alcances
     		...
     		$sql ="INSERT INTO bitacoradealcances (iIdDiario,sContrato,dIdFecha,sIdTurno,sNumeroOrden,sNumeroActividad,sWbs,dCantidad,mDescripcion,dAvance,iFase,sReferencia) VALUES ($iIdDia,'$sContrato','$fecha','$sIdTurno','$sNumeroOrden','$sNumeroActividad','$swbs',$cantidadIns,'$comentarios','$dAvance','$i','$sReferencia')";
 		   mysql_query($sql);
			$iIdDia++;
