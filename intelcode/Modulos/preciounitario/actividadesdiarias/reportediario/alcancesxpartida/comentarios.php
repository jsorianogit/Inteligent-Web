...
<br>Referencias:
<input type="text" name="sReferencia" size=50 onBlur="document.comentario.sReferencia.value=document.comentario.sReferencia.value.toUpperCase();" onKeyPress='return NoComillas(this.form,this,event);' value="<?php echo $sReferencias; ?>">
