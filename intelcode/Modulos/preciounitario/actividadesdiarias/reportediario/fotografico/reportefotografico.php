...
?>
 ...
 <!--onUnLoad="window.open('borraImagen.php?sContrato=<?php echo $sContrato ?>','CIERRE','heigth=10,width=10');" -->
<body>
<?php
...
if(isset($_REQUEST['orden']))
   $_SESSION['ordenFotografico']=$_REQUEST['orden'];
...
//de insertar
$valdefaults = array("sContrato"=>$sContrato,"sNumeroOrden"=>$_SESSION['ordenFotografico'],"sNumeroReporte"=>$_SESSION['numeroFolio'],"iImagen"=>$imagen,"dIdFecha"=>$_SESSION['fecha'],"sIdTurno"=>$_SESSION['turno'],"lIncluye"=>"Si");
//lista de campos que no deben mostrarse en el grid
$ocultos =array("");

$bloqueados =array("sContrato","sIdTurno","dIdFecha","sNumeroReporte","iImagen","sNumeroOrden");
