...
echo "<table nowrap><tr><td>";
$dCostototal=0;
$totales = array("Costo Total");
$personal = array("Fecha","Paquete","Actividad","Descripcion","UM","Cantidad","Precio Unitario","Total");
//obtener el total de bitacora de actividades

$sql = "SELECT sum(a.dVentaMN * b.dCantidad) FROM bitacoradeactividades b INNER JOIN actividadesxanexo a ON (b.sContrato=a.sContrato AND a.sNumeroActividad=b.sNumeroActividad) AND b.sContrato='$sContrato' $CompletarSql AND b.dIdFecha>='$fechaInicio' AND b.dIdFecha<='$fechaFinal'";
...
$sql = "SELECT b.dIdFecha,b.sPaquete,b.sNumeroActividad,b.mDescripcion,a.sMedida,sum(b.dCantidad),a.dVentaMN,sum(b.dCantidad)*a.dVentaMN FROM bitacoradeactividades b INNER JOIN actividadesxanexo a ON (b.sContrato=a.sContrato AND a.sNumeroActividad=b.sNumeroActividad) AND b.sContrato='$sContrato' $CompletarSql AND b.dIdFecha>='$fechaInicio' AND b.dIdFecha<='$fechaFinal' group by b.sNumeroActividad order by b.dIdFecha";
//imprimir resultados
