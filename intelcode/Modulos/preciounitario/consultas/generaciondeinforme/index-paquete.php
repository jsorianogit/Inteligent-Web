...
a.sNumeroActividad,a.mDescripcion,a.dFechaInicio,a.dFechaFinal,a.dCantidadAnexo,a.sMedida,a.dVentaMN,(a.dVentaMN*a.dCantidadAnexo),a.dPonderado,SUM(b.dCantidad),SUM(b.dCantidad 
* a.dVentaMN) as dCostoInstalado from actividadesxanexo a INNER JOIN bitacoradeactividades b ON (a.sContrato=b.sContrato and 
a.sNumeroActividad=b.sNumeroActividad and b.dIdFecha <='$fecha') WHERE a.sContrato='$sContrato' and a.sIdConvenio='$sIdConvenio' AND 
sTipoActividad ='Actividad' GROUp by a.sNumeroActividad,a.sNumeroActividad ORDER BY a.iItemOrden,a.sNumeroActividad",0,$titulos);
$reporte->imprimir();
