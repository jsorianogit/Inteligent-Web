...
class PDF extends FPDF
{
   ...
   function fnImprimeTitulo()
   {
      ...
      $pdf->image($arTitulos[1][0],$x,$y,$tmpAnchoImagen,$tmpAltoImagen);
      $pdf->image($arTitulos[1][1],$tmpLimiteHoja - $tmpAnchoImagen ,$y,$tmpAnchoImagen,$tmpAltoImagen);
...
//		  $pdf->SetFillColor(237,243,216);
   ...
   {
      global $arTitulos;
 	  unlink($arTitulos[1][0]);
   	  unlink($arTitulos[1][1]); 
   }
