...
$sql="Select dCantidadAnexo, sMedida, dVentaMN, dPonderado, dInstalado, dExcedente , (dCantidadAnexo-dInstalado) from actividadesxanexo Where sContrato = '$sContrato' and sIdConvenio = '$sIdConvenio' and sNumeroActividad='$actividad'";
...
$sql="Select sNumeroOrden, sPaquete, sNumeroActividad, substr(mDescripcion,1,25) as mDescripcion, dCantidad,  dFechaInicio, dFechaFinal, dInstalado, dExcedente,(dCantidad-dInstalado) as dPendiente, dPonderado
